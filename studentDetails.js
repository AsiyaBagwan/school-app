$(document).ready(function() {
    ...
    if (studentId) {
        var apiUrl = 'https://f05f388e-0a2b-4879-80e8-6687ab09f493.mock.pstmn.io/students/details'; // Replace with your mock API URL
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response && Array.isArray(response.students)) {
                    ...
                    var student = response.students.find(function(student) {
